...
The cache allows all information to be accessible at the close of the app.
...
The question column is created such that each row is named according to the nested list the question belongs to, followed by an underscore and the name of the list item for the question. The following answers were given for the image considered in the figures above:


```{r, echo=FALSE, warning=FALSE, message=FALSE}
scene_answers <- read_csv("Scene Answers.csv")
selection_answers <- read_csv("Selection Answers.csv")
```
