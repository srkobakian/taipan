...
The *selection* questions are answered for each highlighted area. To make a selection, click on the image and drag the mouse to create a shaded box showing the desired area. The location of the box can be altered by clicking within the shaded area and dragging it to the desired location.
...
Saving one area will then allow a user to select a new area.
...
- The answer to each scene question, labelled by the input id
- The bounding coordinates of the location, labelled xmin, xmax, ymin, ymax
- The answer to each selection question, labelled by the input id
